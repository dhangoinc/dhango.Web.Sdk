...
namespace dhango.Web.Sdk.Api
{
        ...
        public interface IBatchesApi : IApiAccessor
    {
        ...
        /// <returns>GetBatchesResponse</returns>
        GetBatchesResponse BatchesGet (string accountKey = null, string culture = null, int? page = null, int? pageSize = null);
        ...
        /// <param name="page">The current page of the search results starting at 1. (optional, default to 1)</param>
        /// <param name="pageSize">The number of records per page. The default is 25 and the maximum is 50. (optional, default to 25)</param>
        /// <returns>ApiResponse of GetBatchesResponse</returns>
        ApiResponse<GetBatchesResponse> BatchesGetWithHttpInfo (string accountKey = null, string culture = null, int? page = null, int? pageSize = null);
        /// <summary>
        ...
        /// <param name="page">The current page of the search results starting at 1. (optional, default to 1)</param>
        /// <param name="pageSize">The number of records per page. The default is 25 and the maximum is 50. (optional, default to 25)</param>
        /// <returns>Task of GetBatchesResponse</returns>
        System.Threading.Tasks.Task<GetBatchesResponse> BatchesGetAsync (string accountKey = null, string culture = null, int? page = null, int? pageSize = null);
        ...
        /// <param name="page">The current page of the search results starting at 1. (optional, default to 1)</param>
        /// <param name="pageSize">The number of records per page. The default is 25 and the maximum is 50. (optional, default to 25)</param>
        /// <returns>Task of ApiResponse (GetBatchesResponse)</returns>
        System.Threading.Tasks.Task<ApiResponse<GetBatchesResponse>> BatchesGetAsyncWithHttpInfo (string accountKey = null, string culture = null, int? page = null, int? pageSize = null);
        /// <summary>
        /// Gets the summary details of a single batch.
        /// </summary>
        /// <remarks>
        ...
        public partial class BatchesApi : ClientApi, IBatchesApi
    {
        ...
        /// <param name="pageSize">The number of records per page. The default is 25 and the maximum is 50. (optional, default to 25)</param>
        /// <returns>GetBatchesResponse</returns>
        public GetBatchesResponse BatchesGet (string accountKey = null, string culture = null, int? page = null, int? pageSize = null)
        {
             ApiResponse<GetBatchesResponse> localVarResponse = BatchesGetWithHttpInfo(accountKey, culture, page, pageSize);
        ...
        /// <param name="pageSize">The number of records per page. The default is 25 and the maximum is 50. (optional, default to 25)</param>
        /// <returns>ApiResponse of GetBatchesResponse</returns>
        public ApiResponse< GetBatchesResponse > BatchesGetWithHttpInfo (string accountKey = null, string culture = null, int? page = null, int? pageSize = null)
        {
            ...
            return new ApiResponse<GetBatchesResponse>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => string.Join(",", x.Value)),
                (GetBatchesResponse) this.Configuration.ApiClient.Deserialize(localVarResponse, typeof(GetBatchesResponse)));
        }
        ...
        /// <param name="pageSize">The number of records per page. The default is 25 and the maximum is 50. (optional, default to 25)</param>
        /// <returns>Task of GetBatchesResponse</returns>
        public async System.Threading.Tasks.Task<GetBatchesResponse> BatchesGetAsync (string accountKey = null, string culture = null, int? page = null, int? pageSize = null)
        {
             ApiResponse<GetBatchesResponse> localVarResponse = await BatchesGetAsyncWithHttpInfo(accountKey, culture, page, pageSize);
             return localVarResponse.Data;
        ...
        /// <param name="pageSize">The number of records per page. The default is 25 and the maximum is 50. (optional, default to 25)</param>
        /// <returns>Task of ApiResponse (GetBatchesResponse)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<GetBatchesResponse>> BatchesGetAsyncWithHttpInfo (string accountKey = null, string culture = null, int? page = null, int? pageSize = null)
        {
