...
namespace dhango.Web.Sdk.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class PostAuthorizeResponse :  IEquatable<PostAuthorizeResponse>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as PostAuthorizeResponse);
        }

        /// <summary>
        /// Returns true if PostAuthorizeResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of PostAuthorizeResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostAuthorizeResponse input)
        {
            if (input == null)
                return false;
